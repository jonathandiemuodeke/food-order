...
<div class="main-content">
    ...
    <!-- add admin button -->
            ...
            $sql = "SELECT * FROM catering_inquiry ORDER BY id DESC";
            ...
            if($count > 0){
                ...
                ?>
                    ...
                    <!-- <td class="btn-flex"> -->
                    <td>
                        <a href="<?php echo SITEURL; ?>admin/view-message.php?catering-ref=<?php echo $id; ?>" class="btn-primary btn-update">View</a>
                    </td>
