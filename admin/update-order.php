...
<div class="main-content">
    <div class="wrapper">
        ...
        if(isset($_GET['id'])){
            ...
            // $sql = "SELECT * FROM real_order WHERE reference = '$id' ";
            $sql = "SELECT * FROM real_order INNER JOIN paid_order ON real_order.reference = paid_order.reference WHERE real_order.reference = '$id' ";
        ...
        <form action="" method="post">
            <table class="tbl-30">
                <tr>
                    <td>Food name:</td>
                    <td><input type="text" name="food" id="" value="<?php echo $food; ?>"></td>
                </tr>
